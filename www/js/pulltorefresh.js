(function (global, factory) {
  ...
  var _defaults = {
    ...
    classPrefix: 'ptr--',
    cssProp: 'min-height',
    iconArrow: '<img src="/android_asset/www/img/loader1.png" style="height:50px;width:50px;border-radius:4px; z-index: 2000;">',
    iconRefreshing: '',
    instructionsPullToRefresh: '',
    instructionsReleaseToRefresh: '',
    instructionsRefreshing: '<img src="/android_asset/www/img/loader2.gif" style="height:50px;width:50px;border-radius:4px; z-index: 2000;">',
