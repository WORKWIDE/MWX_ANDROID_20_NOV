...
function initMap(map_id, distance_id) {
    Apploadingicon("");
    ...
    calculateAndDisplayRoute(directionsService, directionsDisplay,mapss,distance_id);
}

function calculateAndDisplayRoute(directionsService, directionsDisplay,mapss,distance_id) {
...
<p class='btnFontSizesecondary' style='color:" + localStorage.getItem("s_colorcode") + ";' onclick='Completed_View(" + response.data[0].id + ");'><b> TASK DETAIL </b></p>\
            ...
            hideLoadingIcon();
            //Accept_initMap();
            initMap('Accepted_page_map','distances');
            localStorage.setItem("resume_option", "1");
        } else {
            showAlert("Unable to connect..!!", "WorkWide");
            hideLoadingIcon();
